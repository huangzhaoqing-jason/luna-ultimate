...
Usage:
  ...
  python scripts/scale_train.py --preset 7b --max_steps 500 --dataset auto
...
def main():
    ...
    p.add_argument(
        ...
        help="ModelScope dataset id, 'auto', or 'dummy'",
    )
    args = p.parse_args()
    ...
    if args.smoke or preset == "tiny":
        cmd.append("--smoke")
    if args.allow_large or preset == "550b":
        cmd.append("--allow_large")
    if args.deepspeed:
